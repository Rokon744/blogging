...
const page = ({ params }) => {
    ...
    const fetchBlogData = async() => {
        ...
        const blog = response.data.blogs.find((item)=> params.id === item._id)
        setData(blog);
    }
    ...
    return (data ? <>
        ...
        <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
            ...
            <p className='my-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti repellendus corrupti cumque quidem facilis error. Expedita cumque veritatis ullam esse?</p>
            <p className='my-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti repellendus corrupti cumque quidem facilis error. Expedita cumque veritatis ullam esse?</p>
